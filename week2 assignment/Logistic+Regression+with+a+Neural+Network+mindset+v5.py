...
import lr_utils
get_ipython().magic('pinfo2 lr_utils')
...
print ("y = " + str(train_set_y[0,index]) + ", you predicted that it is a \"" + classes[d["Y_prediction_train"][0,index]].decode("utf-8") +  "\" picture.")
